...
.lang-switch-wrap input[type="radio"] {
  display: none;
}
...
#lang-en:checked ~ .lang-switch-wrap .label-en,
#lang-zh:checked ~ .lang-switch-wrap .label-zh {
  background: #f2f2f2;
  border-color: #bdbdbd;
  font-weight: 600;
}
...
<!-- hidden radio toggles (default: English) -->
<input type="radio" name="lang-toggle" id="lang-en" checked>
<input type="radio" name="lang-toggle" id="lang-zh">

<!-- buttons -->
<div class="lang-switch-wrap">
  <label for="lang-en" class="lang-switch-label label-en">English</label>
  <label for="lang-zh" class="lang-switch-label label-zh">中文</label>
</div>
...
<div class="lang-content content-en">
  ...
  <section class="homepage-section">
    <h2>Biography</h2>
    <p>
      <strong>Hengyi Zhang</strong> is an undergraduate student in <strong>Intelligent Science and Technology</strong> at
  ...
  <section class="homepage-section">
    ...
    <p>
      Participated in research and engineering implementation on <strong>cloud-edge collaborative acceleration for DiT-based video generation</strong>,
...
<!-- Chinese content -->
<div class="lang-content content-zh">
  ...
  <section class="homepage-section">
    ...
    <p>
      当前主要关注<strong>高效生成式人工智能系统</strong>方向，尤其是 <strong>Diffusion / DiT 视频生成模型</strong>在
      <strong>云边协同场景</strong>下的加速与部署问题；同时也持续关注异构边缘设备上的模型适配与系统优化（如 PEFT 相关部署与测试）。
    </p>
    <p>
